...
struct InfoService{
    ...
    static func returnAllLesson() -> [String:[String:[String:[String:[String:String]]]]]{
                let allInfoArray: [String:[String:[String:[String:[String:String]]]]]=["South Korea":["Text":
                    ...
                    "Ghana":["Text":
                        ["Clothing":["zero":["zero":"The Ghanaian smock is made of Kente cloth, and it's the national dress of Ghana.",
                        ...
                        ["Clothing":["zero":["zero":"Traditional clothes for men consist of headdresses, dark vests, belts, and baggy trousers.",
                         ...
                         "Fun Facts":["zero":["zero":"People in Lebanon almost always eat in a family or community.",
                                              "one":"Common foods in Lebanon include pita bread, rice, pasta, hummus (chickpea dip), fool (fava bean dip), and a variety of bean dishes."]]
                                                  ...
                                                  "Music":[
                                                      "zero":["zero":"","one":"lebanonMusic4"],
                                                      "one":["zero":"","one":"lebanonMusic2"]],
                                                  "Art":[
                    ...
                    "Peru":["Text":
                        ["Clothing":["zero":["zero":"The Montera is a traditional hat with a woven strap.",
                         ...
                         "Music":["zero":["zero":"Music in the Andes region is known for the use of flutes, panpipes, and wind instruments.",
                    ...
                    "South Africa":["Text":
                        ["Clothing":["zero":["zero":"South Africa is known for its multicultural population.",
                                     ...
                                     "one":["zero":"Traditional clothes for the Xhosa (ethnic group) consist of shawls and capes.",
                                        "one":"These shawls have detailed designs sewn onto them. Another popular Xhosa tradition is face-painting."]],
    ...
    static func returnQuizInfo() -> [String:[String:[String:[String:String]]]]{
        let quizInfoArray: [String:[String:[String:[String:String]]]]=[
                "Ghana":
                ["Quiz Questions":[
                    "zero":["zero":"Kente is:","one":"  The traditional cloth of Ghana","two":"  A prominent type of dance","three":"  A popular dish"],
               ...
               return quizInfoArray
    }
    
    static func returnBlurbs() -> [String:String]{
    ...
    static func returnSources() -> [String:[String:[String:String]]]{
